...
int main() {
	...
	*/
	...
	// ===== get shaders =====
	GLuint vertexShader = createShader( "transformation/transformation.vert", GL_VERTEX_SHADER );
	GLuint fragmentShader = createShader( "transformation/transformation.frag", GL_FRAGMENT_SHADER );
