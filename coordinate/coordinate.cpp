...
int main() {
	...
	*/
	...
	// ===== get shaders =====
	GLuint vertexShader = createShader( "coordinate/coordinate.vert", GL_VERTEX_SHADER );
	GLuint fragmentShader = createShader( "coordinate/coordinate.frag", GL_FRAGMENT_SHADER );
	...
	// View matrix
	glm::mat4 view;
	// move scene away from camera in the -z direction
